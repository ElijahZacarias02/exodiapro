                        ...
                        <div class="row mt-5 ">
                            <form id="submit_events">
                                <div class="col-md-12 ">
                                    ...
                                    <div id="august" class=" show card" aria-labelledby="headingOne"
                                        data-parent="#accordionExample" style=" background: rgba(0, 0, 0, 0.5);">
                                        <h1 class="text-white text-center my-2"
                                            style="  font-family: 'Nunito Sans', sans-serif;">MBC SCHEDULE</h1>
                                        <div class="row mx-2">
                                            <div class="col-md-8">
                ...
                <table class="table mb-5">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>Start Event</th>
                            <td><input type="text" class="start_event" readonly
                                    style="border: 0; outline: none!important;"></td>

                        </tr>
                        <tr>
                            <th>End Event</th>
                            <td> <input type="text" class="end_event text-center" readonly
                                    style="border: 0; outline: none!important;"></td>
