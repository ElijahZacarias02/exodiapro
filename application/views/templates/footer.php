...
.items span.active {
  color: #fff;
  border-bottom: 1px solid #fff; /* Reduce the width of the underline for active state */
}

.items span.active::before {
  content: "\2605"; /* Unicode for a star symbol */
  position: absolute;
  top: -25px; /* Adjust this value to control the distance between the star and the text */
  left: 50%;
  transform: translateX(-50%);
  font-size: 24px;
  color: #fff;
...
.card-team img {
  width: 100%;
  height: 100%;
  object-fit: cover; /* Add this line to make the image fit within the container */
  border-radius: 50%;
}
...
.vision-mission-section {
  ...
  align-items: stretch; /* Make the cards stretch to have the same height */
  padding: 40px;
}
